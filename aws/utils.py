...
# To use AWS Functions locally, follow the below steps:
# ------------------------------------------------------
# 1. Ensure all libraries in requirements.txt have been pip installed
# 2. Contact peterlmajors@gmail.com to recieve IAM user with proper role
# 3. Enter the supplied: AWS Access Key ID and AWS Secret Key
# 4. Enter default region name (likely us-east-2) and output format (json)
