...
from services.api.agent.schemas import MessageCounts as AgentMessageCounts, Context as AgentContext
...
class AgentStateRedis(AgentState):
    ...
    def from_agent_state(cls, agent_state: AgentState) -> 'AgentStateRedis':
        ...
        return cls(
            ...
            message_counts=MessageCounts(**agent_state.message_counts.model_dump()),
            reduced_context=Context(**agent_state.reduced_context.model_dump()),
    ...
    def to_agent_state(self) -> AgentState:
        ...
        return AgentState(
            ...
            message_counts=AgentMessageCounts(**self.message_counts.model_dump()),
            reduced_context=AgentContext(**self.reduced_context.model_dump()),
